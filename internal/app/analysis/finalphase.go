...
var (
	...
	RHSForward = Tool{
		Name: "RHS Forward",
		Sequence: []gocube.Move{
			{Face: gocube.FaceR, Turn: gocube.CW},
			{Face: gocube.FaceU, Turn: gocube.CW},
			{Face: gocube.FaceR, Turn: gocube.CCW},
			{Face: gocube.FaceU, Turn: gocube.CW},
			{Face: gocube.FaceR, Turn: gocube.CW},
			{Face: gocube.FaceU, Turn: gocube.Double},
			{Face: gocube.FaceR, Turn: gocube.CCW},
		},
	}
	...
	RHSReverse = Tool{
		...
		Sequence: []gocube.Move{
			...
			{Face: gocube.FaceU, Turn: gocube.Double},
			{Face: gocube.FaceR, Turn: gocube.CCW},
			{Face: gocube.FaceU, Turn: gocube.CCW},
			{Face: gocube.FaceR, Turn: gocube.CW},
			{Face: gocube.FaceU, Turn: gocube.CCW},
			{Face: gocube.FaceR, Turn: gocube.CCW},
		},
	...
	LHSForward = Tool{
		Name: "LHS Forward",
		Sequence: []gocube.Move{
			{Face: gocube.FaceL, Turn: gocube.CCW},
			{Face: gocube.FaceU, Turn: gocube.CCW},
			{Face: gocube.FaceL, Turn: gocube.CW},
			{Face: gocube.FaceU, Turn: gocube.CCW},
			{Face: gocube.FaceL, Turn: gocube.CCW},
			{Face: gocube.FaceU, Turn: gocube.Double},
			{Face: gocube.FaceL, Turn: gocube.CW},
...
func AnalyzeFinalPhase(moves []gocube.Move) *FinalPhaseReport {
	...
	// Calculate duration
	if len(moves) > 1 {
		report.FinalPhaseDurationMs = moves[len(moves)-1].Time.UnixMilli() - moves[0].Time.UnixMilli()
	}
